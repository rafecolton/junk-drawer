			...
			<div id="content">
				<div id="sidebar" class='nav'>
					...
					<? endif; ?>
						...
						<div class='nav-item'><a href="<?= HOME_DIR ?>pages/change_password.php">Change Password</a></div>
					...
					if ($("#username").val() == "" || $("#password").val() == "" ){
						...
						$.ajax({
							...
							success: function(data){
										if (data.length < 50 && data.indexOf("authenticated") != -1){
											...
											$('#loading-bar').css("display","none");
											if (!(typeof t == "undefined")) clearTimeout(t);
											$('#error-message').html("Please reload page & try again.");
											$('#error-message').show("slow");
											t = setTimeout(function(){
												$('#error-message').hide("slow");
											},3500);
...
function print_links()
{
	...
	{
		echo "<script type='text/javascript' src='".HOME_DIR."js/$filename'></script>\n";
	}
}
